(function (root, factory) {
    ...
    templatizer["_accomodations"] = function tmpl__accomodations() {
        return '<h1 class="page-header">~ Travel &amp; Accomodations ~</h1><div class="sub-page-content"><div class="inner"><div class="acc-header-image"><img src="images/accomodations/sesmb.00RL01gk-is-241.jpg" class="round-top"/></div><a href="https://www.signup4.net/public/ap.aspx?EID=SMIT39E&amp;OID=130" target="_blank" class="cta header-cta book-now external-link">Book Your Room Now!</a><a href="https://www.signup4.net/Public/ap.aspx?EID=SMIT40E" target="_blank" class="cta header-cta external-link">Submit Flight Info</a><p class="text">We are thrilled you’re joining us in Jamaica for what promises to be a great time! We have a room block set up through Apple Vacations for your stay at Secrets St. James, an all-inclusive resort.</p><p class="text">In order to arrange free travel to and from the resort, don\'t forget to submit your flight info. For more information on flights please visit: <a target="_blank" class="external-link text-link" href="https://www.signup4.net/public/ap.aspx?EID=SMIT39E&OID=161">https://www.signup4.net/public/ap.aspx?EID=SMIT39E&OID=161</a>.</p><p class="text">One thing worth mentioning - we’ve planned the wedding over Columbus Day weekend so our guests can take advantage of having Monday off before diving back into the work week.</p><br/><br/></div></div>';
    };
    ...
    templatizer["_header"] = function tmpl__header() {
        return '<div class="container row logo-wrap"><button class="nav-button"><span class="nav-button-row"></span><span class="nav-button-row"></span><span class="nav-button-row"></span></button><h1 class="header-logo"><a href="#home" class="header-logo-link"><span class="d">D</span><span class="a">A</span></a></h1></div><nav class="container row main-nav"><li><a href="#home">Home</a></li><li><a href="#story">Our Story</a></li><li><a href="#accomodations">Travel &amp; Accomodations</a></li><li><a href="#registry">Registry</a></li><li><a href="https://harriswedding.typeform.com/to/DuW2cS" target="_blank" class="rsvp-link external-link">RSVP</a></li></nav>';
    };
